...
function send_already_registered_mail($to) {
    ...
    $message = '<!Doctype html>
        ...
        Passwort zurücksetzen
                        ...
                        <h3>Das waren Sie nicht?</h3>
                        <p>Sie können diese E-Mail löschen. Ihr Konto bleibt unverändert.</p>
                    </div>
                </main>
                <footer>
                    <a href="http://fraguns.bplaced.net/" style="color:black; text-decoration: none;">FragUns</a> |
...
function send_password_reset_mail($to, $verification_code, $username) {
    $verification_code = (string) $verification_code;
    $subject = "Passwort zurücksetzen | FragUns";
    $message = '<!Doctype html>
        <html lang=de>
            <head>
                <meta charset=UTF-8>
                <meta name=viewport content="width=device-width, initial-scale=1.0">
                <title>FragUns - Passwort zurücksetzen</title>
                <link rel="preconnect" href="https://fonts.googleapis.com">
                <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
                <link href="https://fonts.googleapis.com/css2?family=Varela+Round&display=swap" rel="stylesheet">
            </head>
            ...
            justify-content: center;">
                        ...
                        <a href="http://fraguns.bplaced.net/datenbankprojekt/reset_password_verify.php?username=' . $username . '&code=' . $verification_code . '"  style="color:black; text-decoration: none;">
        Passwort zurücksetzen
        </a>
                        <h3>Das waren Sie nicht?</h3>
                        <p>Sie können diese E-Mail löschen. Das Passwort wird nicht zurückgesetzt.</p>
                    </div>
                </main>
                <footer>
                    <a href="http://fraguns.bplaced.net/" style="color:black; text-decoration: none;">FragUns</a> |
