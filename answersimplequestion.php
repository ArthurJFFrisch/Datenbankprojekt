...
$db = connect_to_database();
    ...
    $sql = $db->prepare("SELECT question_text FROM simple_questions WHERE question_id=? AND group_id=?");
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($db instanceof Throwable) {
        ...
        $sql = $db->prepare("INSERT INTO user_answers_simple_question (group_id, question_id, username, answer) VALUES (?, ?, ?, ?)");
...
$sql = $db->prepare("SELECT COUNT(username) as answer_count FROM user_answers_simple_question WHERE group_id=? AND question_id=?");
        ...
        <main>
            <div class="card">
                ...
                <form id="form" method="post">
                    <?php
                        $sql = $db->prepare("SELECT option_text FROM simple_options WHERE question_id=?");
