...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($db instanceof Throwable) {
        ...
        $sql = $db->prepare("INSERT INTO multiple_choice_questions (group_id, creator_username, expiration_date, question_text) VALUES (?, ?, ?, ?)");
        ...
        foreach (json_decode($_POST["option_array"]) as $option) {
            $sql = $db->prepare("INSERT INTO multiple_choice_options (question_id, option_text) VALUES (?, ?)");
        ...
        <main>
            <div class="card">
                ...
                <form id="form" method="post">
                    <input name="question_text" placeholder="Multiple Choice Frage"></input>
                    ...
                    <button class="option" type="submit"><p>Multiple Choice Frage erstellen</p></button>
                </form>
            </div>
        </main>
        <nav>
